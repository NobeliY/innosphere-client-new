        ...
        <section className='ContentContainer'>
            <div className='MainTop'>
                ...
                <div className='MainContacts'>
                    ...
                    <div className="MContact">
                        ...
                        <p><a href="tel:+79872297205">+7 (987) 229-72-05</a></p>
                        <p><a href="tel:+79888888888">+7 (988) 888-88-88</a></p>
                    </div>
                </div>
            </div>
            <div className='MainPhotoContainer'>
                ...
                <div className='MainInfo'>
                    ...
                    <ul>
                        <li>Индивидуальные развивающие занятия для детей с ОВЗ</li>
                        <li>Репетиторство по всем школьным предметам</li>
                        <li>Интенсивы</li>
                        <li>Курсы</li>
                        <li>Нейрошкола</li>
                    </ul>
            ...
            <div className='MainDirector'>
                ...
                <div className='DirectorInfo'>
                    ...
                    <div className='DirectorText'>
                        ...
                        <p>Научно -развивающий Центр инновационного  развития и творчества:  где детство становится  ярким!</p>
                        ...
                        <p>Концепция Центра:</p>
                        <p>Центр  представляет  собой  инновационное  пространство,  где  дети  могут:</p>
                        <ul>
                            <li>Исследовать</li>
                            <li>Действовать</li>
                            <li>Применить  полученные  знания  на  практике,  участвуя  в  творческих  мастер-классах,  проектах  и  конкурсах</li>
                            <li>Творить:  Развивать  свой  творческий  потенциал,  занимаясь  изобразительным  искусством,  музыкой,  театром,  литературным  творчеством  и  другими  видами  искусства</li>
                        </ul>

                        <p>Преимущества Центра:</p>
                        <ul>
                            <li>Интеграция форматов</li>
                            <li>Развитие талантов:  Специальные  программы  для  одаренных  детей  и  детей  с  особыми  потребностями</li>
                            <li>Открытое пространство:  Центр  открыт  для  всех  желающих,  независимо  от  возраста  и  уровня  подготовки</li>
                        </ul>
                        <p>Научно-развивающий центр  это  не  просто  место  для развития.  Это  пространство,  где  закладываются  фундаменты  будущего,  где  дети  и  молодежь  находят  свои  пути  в  жизнь  и  становятся  успешными  личности.</p>
                    </div>
                </div>
            </div>
