            ...
            <div className='MainDirector'>
                ...
                <div className='DirectorInfo'>
                    ...
                    <div className='DirectorText'>
                        ...
                        <h2>В эпоху стремительного развития технологий и информации,  дети  нуждаются  в  новых  пространствах  для  творческого  развития.  Развивающий Центр- это  именно  такое  пространство,  которое  объединяют  в  себе , инновационные  программы  и  возможности  для  творческой  реализации.</h2>
                        <h2>Миссия Центра:</h2>
                        <h2>Наша миссия -  вдохновлять  детей  на  познавательный  поиск,  развивать  их  творческий  потенциал,  формировать  любознательность  и  стремление  к  самореализации.  Мы  стремимся помочь детям ,используя современные знания в нейропедагогике.</h2>
